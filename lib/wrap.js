...
exports.wrap = function (store, scope, user) {
    ...
    var theProxy = Proxy.create({
      get : function (recv, name) {
        if (name === 'toJSON' && !Object.prototype.hasOwnProperty.call(scope, name)) {
          ...
          if(typeof returnObj === 'function' && Object.prototype.hasOwnProperty.call(scope, name)){
            if(user){
    ...
    function update (key, fqn) {
      ...
      taintedFqns[key][fqn] = (val !== null && val !== undefined && Object.prototype.hasOwnProperty.call(val, 'toFqn'))? val.toFqn() : val;
    }
    ...
    function wrapRoot (rootKey, obj, path, nowObject) {
      ...
      return Proxy.create({
        get : function (recv, name) {
          if (name === 'toJSON' && !Object.prototype.hasOwnProperty.call(obj, name)) {
            return function () { return obj; };
          } else if(name === 'toFqn' && !Object.prototype.hasOwnProperty.call(obj, name)) {
