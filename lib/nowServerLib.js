...
exports.initialize = function(server){
  ...
  server.on('request', function(request, response){
    ...
    if(request.method == "GET"){
      ...
      } else if(request.url == "/nowjs/now.js") {
        serveFile(directory + '/now.js', request, response);
      } else {
...
nowCore.messageHandlers.createScope = function(client, data){
  ...
  everyone.connected.apply(nowCore.scopes[client.sessionId]);
}
...
nowCore.handleDisconnection = function(client) {
  ...
  setTimeout(function(){
    if(!client.connected) {
      everyone.disconnected.apply(nowCore.scopes[client.sessionId]);
